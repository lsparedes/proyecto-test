...
function validateClicks() {
    ...
    resultsDiv.innerHTML = `
        <h2 style="margin-left:20px">Test terminado</h2><br>
        ...
        <button id="downloadCSV">Descargar CSV</button><br>
        <button id="downloadPNG">Descargar Imagen</button><br>
    ...
    document.getElementById('downloadVideo').addEventListener('click', () => {
        ...
        downloadVideo(blob, 'recording.webm');
    });
