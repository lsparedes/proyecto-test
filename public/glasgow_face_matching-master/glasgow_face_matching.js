...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'same/55a.png', 'path': 'same/55a.png'},
    {'name': 'same/56a.png', 'path': 'same/56a.png'},
    {'name': 'same/57c.png', 'path': 'same/57c.png'},
    {'name': 'same/58a.png', 'path': 'same/58a.png'},
    {'name': 'same/59a.png', 'path': 'same/59a.png'},
    {'name': 'same/63a.png', 'path': 'same/63a.png'},
    {'name': 'same/64b.png', 'path': 'same/64b.png'},
    {'name': 'same/69c.png', 'path': 'same/69c.png'},
    {'name': 'same/73a.png', 'path': 'same/73a.png'},
    {'name': 'same/74a.png', 'path': 'same/74a.png'},
    {'name': 'same/75c.png', 'path': 'same/75c.png'},
    {'name': 'same/76b.png', 'path': 'same/76b.png'},
    {'name': 'same/78a.png', 'path': 'same/78a.png'},
    {'name': 'same/79a.png', 'path': 'same/79a.png'},
    {'name': 'same/81b.png', 'path': 'same/81b.png'},
    {'name': 'same/82a.png', 'path': 'same/82a.png'},
    {'name': 'same/84a.png', 'path': 'same/84a.png'},
    {'name': 'same/88b.png', 'path': 'same/88b.png'},
    {'name': 'same/89a.png', 'path': 'same/89a.png'},
    {'name': 'same/98a.png', 'path': 'same/98a.png'},
    {'name': 'different/3c.png', 'path': 'different/3c.png'},
    {'name': 'different/4a.png', 'path': 'different/4a.png'},
    {'name': 'different/7c.png', 'path': 'different/7c.png'},
    {'name': 'different/11b.png', 'path': 'different/11b.png'},
    {'name': 'different/17a.png', 'path': 'different/17a.png'},
    {'name': 'different/18a.png', 'path': 'different/18a.png'},
    {'name': 'different/19b.png', 'path': 'different/19b.png'},
    {'name': 'different/21a.png', 'path': 'different/21a.png'},
    {'name': 'different/22a.png', 'path': 'different/22a.png'},
    {'name': 'different/24b.png', 'path': 'different/24b.png'},
    {'name': 'different/25a.png', 'path': 'different/25a.png'},
    {'name': 'different/26b.png', 'path': 'different/26b.png'},
    {'name': 'different/27b.png', 'path': 'different/27b.png'},
    {'name': 'different/28b.png', 'path': 'different/28b.png'},
    {'name': 'different/29b.png', 'path': 'different/29b.png'},
    {'name': 'different/31b.png', 'path': 'different/31b.png'},
    {'name': 'different/32c.png', 'path': 'different/32c.png'},
    {'name': 'different/35b.png', 'path': 'different/35b.png'},
    {'name': 'different/36c.png', 'path': 'different/36c.png'},
    {'name': 'different/40b.png', 'path': 'different/40b.png'},
...
async function experimentInit() {
  ...
  instructionstxt = new visual.TextBox({
    ...
    letterHeight: 0.05,
    lineSpacing: 1.0,
    size: [1.25, 0.78],  units: undefined,
  ...
  trial_counter = new visual.TextBox({
    ...
    letterHeight: 0.05,
    lineSpacing: 1.0,
    size: [0.23, 0.07],  units: undefined,
    color: 'black', colorSpace: 'rgb',
    fillColor: 'white', borderColor: 'black',
    languageStyle: 'LTR',
    bold: false, italic: false,
  ...
  reminder = new visual.TextBox({
    ...
    letterHeight: 0.05,
    lineSpacing: 1.0,
    size: [0.84, 0.07],  units: undefined,
    color: 'black', colorSpace: 'rgb',
    fillColor: 'white', borderColor: 'black',
    languageStyle: 'LTR',
    bold: false, italic: false,
