...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'orders/prac_stim-order.csv', 'path': 'orders/prac_stim-order.csv'},
    {'name': 'stimuli/slotA_up.jpg', 'path': 'stimuli/slotA_up.jpg'},
    {'name': 'stimuli/slotB_up.jpg', 'path': 'stimuli/slotB_up.jpg'},
    {'name': 'stimuli/slotB_down.jpg', 'path': 'stimuli/slotB_down.jpg'},
    {'name': 'stimuli/slotA_down.jpg', 'path': 'stimuli/slotA_down.jpg'},
    {'name': 'orders/sub-00_stim-order.csv', 'path': 'orders/sub-00_stim-order.csv'},
    {'name': 'stimuli/slot1_up.jpg', 'path': 'stimuli/slot1_up.jpg'},
    {'name': 'stimuli/slot2_up.jpg', 'path': 'stimuli/slot2_up.jpg'},
    {'name': 'stimuli/slot2_down.jpg', 'path': 'stimuli/slot2_down.jpg'},
    {'name': 'stimuli/slot1_down.jpg', 'path': 'stimuli/slot1_down.jpg'},
    {'name': 'orders/sub-01_stim-order.csv', 'path': 'orders/sub-01_stim-order.csv'},
    {'name': 'stimuli/slot1_up.jpg', 'path': 'stimuli/slot1_up.jpg'},
    {'name': 'stimuli/slot2_up.jpg', 'path': 'stimuli/slot2_up.jpg'},
    {'name': 'stimuli/slot2_down.jpg', 'path': 'stimuli/slot2_down.jpg'},
    {'name': 'stimuli/slot1_down.jpg', 'path': 'stimuli/slot1_down.jpg'},
    {'name': 'orders/sub-03_stim-order.csv', 'path': 'orders/sub-03_stim-order.csv'},
    {'name': 'stimuli/slot1_up.jpg', 'path': 'stimuli/slot1_up.jpg'},
    {'name': 'stimuli/slot2_up.jpg', 'path': 'stimuli/slot2_up.jpg'},
    {'name': 'stimuli/slot2_down.jpg', 'path': 'stimuli/slot2_down.jpg'},
    {'name': 'stimuli/slot1_down.jpg', 'path': 'stimuli/slot1_down.jpg'},
    {'name': 'orders/sub-05_stim-order.csv', 'path': 'orders/sub-05_stim-order.csv'},
    {'name': 'stimuli/slot1_up.jpg', 'path': 'stimuli/slot1_up.jpg'},
    {'name': 'stimuli/slot2_up.jpg', 'path': 'stimuli/slot2_up.jpg'},
    {'name': 'stimuli/slot2_down.jpg', 'path': 'stimuli/slot2_down.jpg'},
    {'name': 'stimuli/slot1_down.jpg', 'path': 'stimuli/slot1_down.jpg'},
...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + `data/sub-${expInfo["participant"]}_task-${expName}`);
...
function instr1RoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('instr1.started', globalClock.getTime());
...
function instr1RoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('instr1.stopped', globalClock.getTime());
    key_resp_2.stop();
...
function prac_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('prac_instr.started', globalClock.getTime());
...
function prac_instrRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('prac_instr.stopped', globalClock.getTime());
    key_resp_7.stop();
...
var practice_round;
function practice_roundLoopBegin(practice_roundLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisPractice_round of practice_round) {
      snapshot = practice_round.getSnapshot();
      ...
      practice_roundLoopScheduler.add(BlockInstructRoutineEachFrame());
      ...
      practice_roundLoopScheduler.add(stimuli_feedbackRoutineEachFrame());
      ...
      practice_roundLoopScheduler.add(feedbackRoutineEachFrame());
      practice_roundLoopScheduler.add(feedbackRoutineEnd(snapshot));
      practice_roundLoopScheduler.add(practice_roundLoopEndIteration(practice_roundLoopScheduler, snapshot));
    }
...
async function practice_roundLoopEnd() {
  // terminate loop
...
function practice_roundLoopEndIteration(scheduler, snapshot) {
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrial of trials) {
      ...
      trialsLoopScheduler.add(BlockInstructRoutineEachFrame());
      ...
      trialsLoopScheduler.add(stimuli_feedbackRoutineEachFrame());
...
function BlockInstructRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    psychoJS.experiment.addData('BlockInstruct.started', globalClock.getTime());
...
function BlockInstructRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('BlockInstruct.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function stimuli_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(0.500000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('stimuli_feedback.started', globalClock.getTime());
    ...
    for (const thisComponent of stimuli_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stimuli_feedbackRoutineEachFrame() {
  return async function () {
...
function stimuli_feedbackRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('stimuli_feedback.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    if ((! key_resp.keys)) {
        outcome = "omitido";
        psychoJS.experiment.addData("cumulativePts_self", ptsSelf);
        if ((condition !== "practice")) {
            psychoJS.experiment.addData("outcomeDescr", "missed");
        }
    } else {
        if (key_resp.corr) {
            if ((goal === "win")) {
                if ((condition === "self")) {
                    ...
                    ptsSelf += 100;
                    psychoJS.experiment.addData("cumulativePts_self", ptsSelf);
                    psychoJS.experiment.addData("outcomeDescr", "self win");
                    psychoJS.experiment.addData("outcome", 1);
                } else {
                    if ((condition === "practice")) {
                        outcome = "+100 points";
                    }
            ...
            if ((goal === "win")) {
                if ((condition === "self")) {
                    ...
                    ptsSelf += 0;
                    psychoJS.experiment.addData("cumulativePts_self", ptsSelf);
                    psychoJS.experiment.addData("outcomeDescr", "self avoid win");
                    psychoJS.experiment.addData("outcome", 0);
                } else {
                    if ((condition === "practice")) {
                        outcome = "0 points";
                    }
    ...
    if ((condition === "practice")) {
        psychoJS.experiment.addData("cumulativePts_self", 1000);
        psychoJS.experiment.addData("outcomeDescr", "practice");
    }
...
function instr4RoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('instr4.started', globalClock.getTime());
...
function instr4RoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('instr4.stopped', globalClock.getTime());
    key_resp_8.stop();
