...
expName = 'Español Digit Span Task'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\xampp\\htdocs\\proyecto-tests\\public\\proyecto-digit-span-en-espanol-master\\Español Digit Span Task_lastrun.py',
