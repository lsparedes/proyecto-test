                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            ¡Bienvenido a la plataforma, {{ $email }}!</h1>
                                        <p
                                            ...
                                            Estamos emocionados de tenerte con nosotros. Para completar tu registro y
                                            asegurar tu cuenta, es necesario establecer una contraseña segura.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Tu contraseña temporal es: <b>{{ $password }}</b></p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Por favor, sigue el enlace para acceder a la plataforma y luego cambiar tu
                                        ...
                                        <p
                                            ...
                                            recordar fácilmente pero que sea segura. Una vez que inicies sesión, ve a la
                                            configuración de tu perfil para actualizar tu contraseña.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2024 NeuroTest. All rights reserved.</p>
