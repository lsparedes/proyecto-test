            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/update-tests/' . $test->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_test" value="{{ old('name_test', $test->name_test) }}"
                            class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="nombre_espa">Nombre Test (español)</label>
                        <input type="text" name="nombre_espa" value="{{ old('nombre_espa', $test->nombre_espa) }}"
                            class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="descripcion_individual">Descripción individual</label>
                        <textarea name="descripcion_individual" class="form-control"
                            rows="4">{{ old('descripcion_individual', $test->descripcion_individual) }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="duracion_minutos"
                            value="{{ old('duracion_minutos', $test->duracion_minutos) }}" class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="modulo" id="modulo" class="form-control">
                            <option value="1" {{ old('modulo', $test->modulo) == 1 ? 'selected' : '' }}>Módulo 1</option>
                            <option value="2" {{ old('modulo', $test->modulo) == 2 ? 'selected' : '' }}>Módulo 2</option>
                            <option value="3" {{ old('modulo', $test->modulo) == 3 ? 'selected' : '' }}>Módulo 3</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="nombre_url">Nombre de la URL</label>
                        <input type="text" name="nombre_url" value="{{ old('nombre_url', $test->nombre_url) }}"
                            class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="url_test">URL del Test</label>
                        <input type="text" name="url_test" value="{{ old('url_test', $test->url_test) }}"
                            class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="nombre_url_opcional">Nombre de la URL opcional</label>
                        <input type="text" name="nombre_url_opcional"
                            value="{{ old('nombre_url_opcional', $test->nombre_url_opcional) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="url_adicional">URL adicional del Test (opcional)</label>
                        <input type="text" name="url_adicional" value="{{ old('url_adicional', $test->url_adicional) }}"
                            class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="link_millisecond">URL del test (opcional)</label>
                        <input type="text" name="link_millisecond"
                            value="{{ old('link_millisecond', $test->link_millisecond) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="link_millisecond2">Link Millisecond 2 (opcional)</label>
                        <input type="text" name="link_millisecond2"
                            value="{{ old('link_millisecond2', $test->link_millisecond2) }}" class="form-control">
                    </div>
